    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine($"Строка c числами от 0 до {value1}: {cycle.listNums(value1)} \n");
            ...
            do
            {
                ...
                Console.WriteLine($"Строка с чётными числами от 0 до {value3}: {cycle.chet(value3)} \n");
            ...
            do
            {
                ...
                Console.WriteLine($"Длина числа {value5}: {cycle.numLen(value5)} \n");
